...
public class MapTool extends Application{
    ...
    public void start(Stage primaryStage) {
        ...
        controls.getChildren().addAll(xField, yField, nameField, isPlace, createNodeButton,deleteNodeButton,createEdgeButton, deleteEdgeButton);  
  
        File mapFile = new File("/Users/wuzhizhen/Documents/CS3733_Graphics/AK2.png");

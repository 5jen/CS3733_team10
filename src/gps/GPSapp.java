...
public class GPSapp extends Application {
	...
	public void init() throws Exception {
		// System.out.println(GPSapp.STEP() + "MyApplication#init (doing some
		// heavy lifting), thread: " + Thread.currentThread().getName());
	...
	public void start(Stage primaryStage) {
		...
		scene.widthProperty().addListener(new ChangeListener<Number>() {
			...
			public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
				...
				// TODO asdasd//TODO asdasd//TODO asdasd//TODO asdasd//TODO
				// asdasd
				// TODO asdasd
				// TODO asdasd
				// TODO asdasd
		...
		DestText.textProperty().addListener(new ChangeListener<Object>() {
		...
		StartText.textProperty().addListener(new ChangeListener<Object>() {
		...
		DestText.setOnKeyPressed(new EventHandler<KeyEvent>() {
			...
			public void handle(KeyEvent event) {
				...
				if (event.getCode() == KeyCode.ENTER) {
					// TODO check to see if actual node was selected in both
					// textfields
					findAndDisplayRoute(imageView);
				}
			}
	...
	private void getMapSelector(Building building, Pane root, ImageView imageView) {
		...
		LayerGroup.setOnMouseExited(new EventHandler<MouseEvent>() {
			...
			private void fadeOutLayeredGroup(Group layerGroup) {
				...
				// remove the layered group from stage when we roll out after it
				// fades out
